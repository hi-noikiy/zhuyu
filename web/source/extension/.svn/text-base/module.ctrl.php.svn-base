...
if($do == 'installed') {
	...
	if (!empty($modules)) {
		foreach ($modules as $mid => $module) {
			...
			$modules[$mid]['official'] = empty($module['issystem']) && (strexists($module['author'], 'baimuv Team') || strexists($module['author'], 'baimuv'));
...
<manifest xmlns="http://www.baimuv.com" versionCode="{$versions}">
