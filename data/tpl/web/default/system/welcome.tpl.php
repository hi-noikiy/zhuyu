	...
	<div class="clearfix" style="margin-bottom:5em;">
		...
		<div class="clearfix">
			...
			<a href="<?php  echo url('cloud/addons');?>" class="tile tile-2x img-rounded" target="_blank">
				...
				<?php  if(file_exists(IA_ROOT.'/addons/ewei_shop/defines.php') ) { ?>		
			<a href="./index.php?c=site&a=entry&do=upgrade&m=ewei_shop" class="tile tile-2x img-rounded" >
				<i class="fa fa-refresh"></i>
				<span>人人商城一键更新</span>
			</a>
		<?php  } else { ?>
		<a  href="http://wpa.qq.com/msgrd?v=3&uin=1601408008&site=qq&menu=yes" class="tile tile-2x img-rounded" target="_blank">
