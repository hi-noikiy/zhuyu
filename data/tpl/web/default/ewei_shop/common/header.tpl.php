	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<?php  if(IMS_FAMILY != 'x') { ?>
				<li><a href="http://www.baimuv.com"><i class="fa fa-comment"></i>百木微风</a></li>
				<li><a href="http://wpa.qq.com/msgrd?v=3&uin=1601408008&site=qq&menu=yes"><i class="fa fa-suitcase"></i>联系客服</a></li>
				<?php  } ?>
			</ul>
		...
		<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					...
					<?php  if(IMS_FAMILY != 'x') { ?>
						<li><a href="http://www.baimuv.com"><i class="fa fa-comment"></i>百木微风</a></li>
						<li><a href="http://wpa.qq.com/msgrd?v=3&uin=1601408008&site=qq&menu=yes"></i>联系客服</a></li>
					<?php  } ?>
				</ul>
				<ul class="nav navbar-nav navbar-right">
