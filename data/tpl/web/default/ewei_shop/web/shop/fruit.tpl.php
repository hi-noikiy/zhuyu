            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:left;">
                        <?php if(cv('shop.adv.view|shop.adv.edit')) { ?><a href="<?php  echo $this->createWebUrl('shop/fruit', array('op' => 'post', 'id' => $row['id']))?>" class="btn btn-default btn-sm" 
                                                               title="<?php if(cv('shop.adv.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>"><i class="fa fa-edit"></i></a><?php  } ?>
                        <?php if(cv('shop.adv.delete')) { ?><a href="<?php  echo $this->createWebUrl('shop/fruit', array('op' => 'delete', 'id' => $row['id']))?>"class="btn btn-default btn-sm" onclick="return confirm('确认删除?')" title="删除"><i class="fa fa-times"></i></a><?php  } ?>
                    </td>
                </tr>
                <?php  } } ?> 
                <tr>
                    <td colspan='6'>
                        <?php if(cv('shop.adv.add')) { ?>
                          <a class='btn btn-default' href="<?php  echo $this->createWebUrl('shop/fruit',array('op'=>'post'))?>"><i class='fa fa-plus'></i>添加水果夹心</a>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style="color:red">*</span>水果夹心名称</label>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">水果夹心图片</label>
                    <div class="col-sm-9 col-xs-12">
                         <?php if( ce('shop.adv' ,$item) ) { ?>
                        <?php  echo tpl_form_field_image('thumb', $item['thumb'])?>
                        <span class='help-block'>建议尺寸: 60*60  请将水果夹心图片尺寸保持一致</span>
                        <?php  } else { ?>
