...
<div class="form-group">
    <label class="col-xs-12 col-sm-3 col-md-2 control-label">商品介绍(简介)</label>
    <div class="col-sm-6 col-xs-6">
          <?php if( ce('shop.goods' ,$item) ) { ?>
        <input type="text" name="summary" id="summary" class="form-control" value="<?php  echo $item['summary'];?>" />
        <span class="help-block"></span>
        <?php  } else { ?>
           <div class='form-control-static'><?php  echo $item['summary'];?></div>
        <?php  } ?>
    </div>
</div>
...
<div class="form-group">
    <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否赠送附属礼品</label>
    <div class="col-sm-9 col-xs-12">
            <?php if( ce('shop.adv' ,$item) ) { ?>
        <label class='radio-inline'>
            <input type='radio' name='isgift' value=1' <?php  if($item['isgift']==1) { ?>checked<?php  } ?> /> 是
        </label>
        <label class='radio-inline'>
            <input type='radio' name='isgift' value=0' <?php  if($item['isgift']==0) { ?>checked<?php  } ?> /> 否
        </label>
     <?php  } else { ?>
            <div class='form-control-static'><?php  if(empty($item['isgift'])) { ?>否<?php  } else { ?>是<?php  } ?></div>
        <?php  } ?>
    </div>
</div>
