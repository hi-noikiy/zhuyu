...
<script language="javascript">
	...
	for(var i=0;i<newlen;i++){
		...
		var val ={ id : "",title:titles, stock : "",costprice : "",productprice : "",marketprice : "",weight:"",diameter:"",fitnumber:"",tableware:"",scheduletime:"",productsn:"",goodssn:"",virtual:virtuals };
		if( $(".option_id_" + ids).length>0){
			val ={
				...
				diameter : $(".option_diameter_" + ids+":eq(0)").val(),
				fitnumber : $(".option_fitnumber_" + ids+":eq(0)").val(),
				tableware : $(".option_tableware_" + ids+":eq(0)").val(),
				scheduletime : $(".option_scheduletime_" + ids+":eq(0)").val(),
                                  virtual : virtuals
			}
		}
		hh += '<td class="info">'
		...
		hh += '<td class="info"><input name="option_diameter_' + ids +'[]" type="text" class="form-control option_diameter option_diameter_' + ids +'" " value="' +(val.diameter=='undefined'?'':val.diameter )+'"/></td>';		
		hh += '<td class="info"><input name="option_fitnumber_' + ids +'[]" type="text" class="form-control option_fitnumber option_fitnumber_' + ids +'" " value="' +(val.fitnumber=='undefined'?'':val.fitnumber )+'"/></td>';				
		hh += '<td class="info"><input name="option_tableware_' + ids +'[]" type="text" class="form-control option_tableware option_tableware_' + ids +'" " value="' +(val.tableware=='undefined'?'':val.tableware )+'"/></td>';				
		hh += '<td class="info"><input name="option_scheduletime_' + ids +'[]" type="text" class="form-control option_scheduletime option_scheduletime_' + ids +'" " value="' +(val.scheduletime=='undefined'?'':val.scheduletime )+'"/></td>';				
		hh += "</tr>";
	}
	html+=hh;
	html+="</table>";
