<?php defined('IN_IA') or exit('Access Denied');?><ul class="nav nav-tabs">
    ...
    <?php if(cv('shop.adv.view')) { ?><li <?php  if($_GPC['p'] == 'birthdaycard') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shop/birthdaycard')?>">生日牌管理</a></li><?php  } ?>   
    <?php if(cv('shop.adv.view')) { ?><li <?php  if($_GPC['p'] == 'cakehat') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shop/cakehat')?>">蛋糕帽管理</a></li><?php  } ?>      
    <?php if(cv('shop.adv.view')) { ?><li <?php  if($_GPC['p'] == 'birthdaycandle') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shop/birthdaycandle')?>">生日蜡烛管理</a></li><?php  } ?>  
    <?php if(cv('shop.adv.view')) { ?><li <?php  if($_GPC['p'] == 'fruit') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shop/fruit')?>">水果夹心管理</a></li><?php  } ?>    
