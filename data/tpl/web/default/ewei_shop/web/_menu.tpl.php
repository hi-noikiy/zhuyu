        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <?php if(cv('shop.comment')) { ?><li><a href="<?php  echo $this->createWebUrl('shop/comment')?>">评价管理</a></li><?php  } ?>
                                  <li><a href="<?php  echo $this->createPluginWebUrl('coupon')?>">优惠券管理</a></li>
        ...
        <li>
            <a href='javascript;:' class="dropdown-toggle" data-toggle="dropdown"><i class='fa fa-file-text-o'></i> 订单管理 <i class="fa fa-angle-down"></i></a>
             <ul class="dropdown-menu">
                ...
                <?php if(cv('order.view.status1')) { ?><li ><a href="<?php  echo $this->createWebUrl('order', array('op' => 'display', 'status' => 6))?>">待制作</a></li><?php  } ?>
                <?php if(cv('order.view.status1')) { ?><li ><a href="<?php  echo $this->createWebUrl('order', array('op' => 'display', 'status' => 7))?>">制作中</a></li><?php  } ?>
                <?php if(cv('order.view.status2')) { ?><li ><a href="<?php  echo $this->createWebUrl('order', array('op' => 'display', 'status' => 2))?>">运输中</a></li><?php  } ?>
