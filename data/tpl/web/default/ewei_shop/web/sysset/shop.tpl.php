    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" >
        ...
        <div class="panel panel-default">
            ...
            <div class='panel-body'>  
	  		...
	  		<div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">商城公告</label>
                    <div class="col-sm-9 col-xs-12">

			 			<?php  echo tpl_ueditor('shop[notice]',$set['shop']['notice'])?>
 	  		...
 	  		<div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">企业订购</label>
                    <div class="col-sm-9 col-xs-12">

			 			<?php  echo tpl_ueditor('shop[companytoorder]',$set['shop']['companytoorder'])?>
