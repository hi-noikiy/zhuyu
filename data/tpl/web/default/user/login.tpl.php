...
<div class="login">
				...
				<form action="" method="post" role="form" id="form1" onsubmit="return formcheck();">
					...
					<div class="form-group">
						<label class="checkbox-inline input-lg">
							<input type="checkbox" value="true" name="rember"> 记住用户名 <font color="red">[如没有账户请点击注册按钮进入注册！]</font>
						</label>
	...
	<div class="center-block footer" role="footer">
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://www.baimuv.com">关于百木微风</a>&nbsp;&nbsp;<a href="http://bbs.baimuv.com">百木微风论坛</a>&nbsp;&nbsp;<a href="http://wpa.qq.com/msgrd?v=3&uin=1601408008&site=qq&menu=yes">联系客服</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>
		</div>
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.baimuv.com"><b>百木微风</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2016 <a href="http://www.baimuv.com">www.baimuv.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
		</div>
	</div>
</div>
<script>
