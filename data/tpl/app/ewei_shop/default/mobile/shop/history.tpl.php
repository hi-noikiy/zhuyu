...
.history_top {height:44px;  background:#f8f8f8; padding:0px 3%; border-bottom:1px solid #e3e3e3;}
...
.history_good .img {height:80px; width:80px; background:#f99; float:left;z-index:2;position: relative;}
