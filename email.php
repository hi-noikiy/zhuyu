...
class MySendMail {
    ...
    * @return boolean
    */
    public function sendMail($from = 'MyResume') {
        $command = $this->getCommand($from);
        $this->socket();
    ...
    * @return array
    */
    protected function getCommand($from) {
        $command = array(
                array("HELO sendmail\r\n", 250)
            );
...
/**************************** Test ***********************************/
$mail = new MySendMail();
$mail->setServer("smtp.baimuv.com", "kaifa@baimuv.com", "Hero888888");
$mail->setFrom("kaifa@baimuv.com");
$mail->setReceiver($_POST['email']);
$mail->setMailInfo($_POST['title'], $_POST['content']);
$mail->sendMail($_POST['from']);
