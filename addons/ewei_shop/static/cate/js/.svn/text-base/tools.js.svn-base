(function($) {
	...
	var tools = {
		...
		//表单验证
		validForm: function (_this, isshowErr, wrap, tipsrc) {
			var b = true;
			var tips = '', imgStyle= 'width="10px" style="margin-right: 5px"';
			isshowErr = typeof isshowErr === 'undefined' ? false:isshowErr;
			wrap = wrap ? wrap:'text';
			$(_this).find('*').each(function() {
				if (isshowErr) {
					/*$(this).blur(function() {
						Tools.validForm(_this, true, wrap, tipsrc);
					});*/
				}
				if(typeof($(this).attr("verify")) !== "undefined") {
					var data = $.trim($(this).val());
					if(data.length < 1) {
						var msg = $(this).attr("msg-title");
						msg += "不能为空";
						b = false;
						if(!b && !isshowErr) {
							Tools.alert(msg);
						...
						if (!b && isshowErr) {
							console.log(b);
							tips = '<img '+imgStyle+' src="'+tipsrc+'" alt="提示">'+ msg;
							$(this).parent('.'+ wrap).find('.tips-err').show().html(tips);
						}
					} else {
						//  合法校验
						b = validData(data, $(this).attr("verify"));
						if(!b && !isshowErr) {
							Tools.alert($(this).attr("msg"));
							return b;
						}
						if(!b && isshowErr) {
							tips = '<img '+imgStyle+' src="'+tipsrc+'" alt="提示">'+ $(this).attr('msg');
							$(this).parent('.'+ wrap).find('.tips-err').show().html(tips);
							return b;
						}else {
							$(this).parent('.'+ wrap).find('.tips-err').html('').hide();
							return b;
						}
					}
				}
			...
			//验证密码是否一致
			var b1 = true;
			var pwd = $(_this).find('[checkpwd]');
			if (pwd.length == 2 && b) {
				if (pwd[0].value === pwd[1].value){
					b1 = true;
				} else {
					if (!isshowErr) {						
						Tools.alert('两次密码输入不一致!');
					}else {
						tips = '<img '+imgStyle+' src="'+tipsrc+'" alt="提示">两次密码输入不一致!';
						$('#checkpwd').show().html(tips);
					}
					b1 = false;
				}
			}
		...
		alert: function(msg, fun, btn, effect) {
			...
			var mask = $('<div id="mask-alert-id"><div style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(0,0,0,.5);z-index:10;" class="close-modal"></div><div id="mask-effect" style="'+scale+'position: absolute;width: 80%;left: 50%;top: 30%;border-radius: 5px;margin-left: -40%;background-color: #fff; z-index: 11"><div ><h2 style="text-align: center;font-size: 16px;font-weight: normal;margin: 10px;">提示</h2><p style="margin: 10px;text-align: center;font-size: 14px;word-break: break-all;">' + msg + '</p><div style="display: flex;display: -webkit-flex;justify-content: space-between;height:40px;line-height:40px;box-sizing: border-box;text-align: center;font-size: 14px;border-top: 1px solid #ddd;"><p id="sure-btn" class="btn-active" style="margin: 0;padding: 0;width: 100%;padding: 0 10px;border-right: 1px solid #ddd;border-radius: 2px;">确定</p>'+btn+'</div><div class="close-modal"></div></div></div></div>');
		...
		showIndicator: function() {
			var dom = $('<div id="loadding-dom"><style>#loading{height:100%;width:100%;position:fixed;z-index:1;margin-top:0;top:0}#loading-center{width:100%;height:100%;position:relative}#loading-center-absolute{position:absolute;left:50%;top:50%;height:50px;width:50px;margin-top:-25px;margin-left:-25px;-ms-transform:rotate(45deg);-webkit-transform:rotate(45deg);transform:rotate(45deg);-webkit-animation:loading-center-absolute 1.5s infinite;animation:loading-center-absolute 1.5s infinite}.object{width:25px;height:25px;background-color:#f6d8d8;float:left}#object_one{-webkit-animation:object_one 1.5s infinite;animation:object_one 1.5s infinite}#object_two{-webkit-animation:object_two 1.5s infinite;animation:object_two 1.5s infinite}#object_three{-webkit-animation:object_three 1.5s infinite;animation:object_three 1.5s infinite}#object_four{-webkit-animation:object_four 1.5s infinite;animation:object_four 1.5s infinite}@-webkit-keyframes loading-center-absolute{100%{-webkit-transform:rotate(-45deg)}}@keyframes loading-center-absolute{100%{transform:rotate(-45deg);-webkit-transform:rotate(-45deg)}}@-webkit-keyframes object_one{25%{-webkit-transform:translate(0,-50px) rotate(-180deg)}100%{-webkit-transform:translate(0,0) rotate(-180deg)}}@keyframes object_one{25%{transform:translate(0,-50px) rotate(-180deg);-webkit-transform:translate(0,-50px) rotate(-180deg)}100%{transform:translate(0,0) rotate(-180deg);-webkit-transform:translate(0,0) rotate(-180deg)}}@-webkit-keyframes object_two{25%{-webkit-transform:translate(50px,0) rotate(-180deg)}100%{-webkit-transform:translate(0,0) rotate(-180deg)}}@keyframes object_two{25%{transform:translate(50px,0) rotate(-180deg);-webkit-transform:translate(50px,0) rotate(-180deg)}100%{transform:translate(0,0) rotate(-180deg);-webkit-transform:translate(0,0) rotate(-180deg)}}@-webkit-keyframes object_three{25%{-webkit-transform:translate(-50px,0) rotate(-180deg)}100%{-webkit-transform:translate(0,0) rotate(-180deg)}}@keyframes object_three{25%{transform:translate(-50px,0) rotate(-180deg);-webkit-transform:translate(-50px,0) rotate(-180deg)}100%{transform:translate(0,0) rotate(-180deg);-webkit-transform:rtranslate(0,0) rotate(-180deg)}}@-webkit-keyframes object_four{25%{-webkit-transform:translate(0,50px) rotate(-180deg)}100%{-webkit-transform:translate(0,0) rotate(-180deg)}}@keyframes object_four{25%{transform:translate(0,50px) rotate(-180deg);-webkit-transform:translate(0,50px) rotate(-180deg)}100%{transform:translate(0,0) rotate(-180deg);-webkit-transform:translate(0,0) rotate(-180deg)}}</style><div id="loading"><div id="loading-center"><div id="loading-center-absolute"><div class="object" id="object_one"></div><div class="object" id="object_two"></div><div class="object" id="object_three"></div><div class="object" id="object_four"></div></div></div></div></div>');
			$('body').append(dom);
		},
		...
		sendSms: function (__this, params) {
			 ...
			 *
			 **/
			selItems: function (ele, callback) {
