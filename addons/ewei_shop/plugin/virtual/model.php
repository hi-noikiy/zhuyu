...
', $_var_16);
            ...
            $_var_23 = $_var_1['total'] * $_var_9['credit'];
            if ($_var_23 > 0) {
                $_var_24 = m('common')->getSysset('shop');
                m('member')->setCredit($_var_11['openid'], 'credit1', $_var_23, array(0, $_var_24['name'] . '购物积分 订单号: ' . $_var_11['ordersn']));
            }
