	...
	class CommissionModel extends PluginModel
	{
		...
		function sendMessage($_var_21 = '', $_var_151 = array(), $_var_152 = '')
		{
			...
			if ($_var_152 == TM_COMMISSION_AGENT_NEW && !empty($_var_153["commission_agent_new"]) && empty($_var_155["commission_agent_new"])) {
				...
				if ($_var_152 == TM_COMMISSION_ORDER_PAY && !empty($_var_153["commission_order_pay"]) && empty($_var_155["commission_order_pay"])) {
					...
					if ($_var_152 == TM_COMMISSION_ORDER_FINISH && !empty($_var_153["commission_order_finish"]) && empty($_var_155["commission_order_finish"])) {
						...
						if ($_var_152 == TM_COMMISSION_APPLY && !empty($_var_153["commission_apply"]) && empty($_var_155["commission_apply"])) {
							...
							if ($_var_152 == TM_COMMISSION_CHECK && !empty($_var_153["commission_check"]) && empty($_var_155["commission_check"])) {
								...
								if ($_var_152 == TM_COMMISSION_PAY && !empty($_var_153["commission_pay"]) && empty($_var_155["commission_pay"])) {
									...
									if ($_var_152 == TM_COMMISSION_UPGRADE && !empty($_var_153["commission_upgrade"]) && empty($_var_155["commission_upgrade"])) {
										...
										if ($_var_152 == TM_COMMISSION_BECOME && !empty($_var_153["commission_become"]) && empty($_var_155["commission_become"])) {
