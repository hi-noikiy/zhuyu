        ...
        if ($operation == 'complete' && $_W['ispost']) {
            ...
            if (!empty($log) && empty($log['status'])) {
                ...
                if (!is_error($payquery)) {
                    ...
                    m('member')->setCredit($openid, 'credit2', $log['money'], array(0, '人人商城会员充值:wechatcomplete:credit2:' . $log['money']));
            ...
            if ($operation == 'return') {
                ...
                if (!empty($log) && empty($log['status'])) {
                    ...
                    m('member')->setCredit($openid, 'credit2', $log['money'], array(0, '人人商城会员充值:alipayreturn:credit2:' . $log['money']));
                    m('member')->setRechargeCredit($openid, $log['money']);
                    if (p('sale')) {
                        p('sale')->setRechargeActivity($log);
                    }
