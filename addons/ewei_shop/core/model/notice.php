		...
		if ($_var_1) {
			...
			if (!empty($_var_2['refundid'])) {
				...
				if (empty($_var_15['status'])) {
					$_var_16 = array('first' => array('value' => '您的' . $_var_14[$_var_15['rtype']] . '申请已经提交！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => $_var_15['rtype'] == 3 ? '-' : ('yen' . $_var_15['applyprice'] . '元'), 'color' => '#4a5077'), 'orderProductName' => array('title' => '商品详情', 'value' => $_var_6 . $_var_8, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $_var_2['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => '
等待商家确认' . $_var_14[$_var_15['rtype']] . '信息！', 'color' => '#4a5077'),);
					...
					$_var_16 = array('first' => array('value' => '您的' . $_var_14[$_var_15['rtype']] . '申请已经通过！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => $_var_15['rtype'] == 3 ? '-' : ('yen' . $_var_15['applyprice'] . '元'), 'color' => '#4a5077'), 'orderProductName' => array('title' => '商品详情', 'value' => $_var_6 . $_var_8, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $_var_2['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => '
...
【' . $_var_12['name'] . '】期待您再次购物！', 'color' => '#4a5077'));
						...
						$_var_16 = array('first' => array('value' => '您的订单已经完成退款！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => 'yen' . $_var_15['price'] . '元', 'color' => '#4a5077'), 'orderProductName' => array('title' => '商品详情', 'value' => $_var_6 . $_var_8, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $_var_2['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => '
 退款金额 yen' . $_var_15['price'] . "{$_var_20}\r\n 【" . $_var_12['name'] . '】期待您再次购物！', 'color' => '#4a5077'));
					}
...
客服电话:  ' . $_var_12['phone'];
					...
					$_var_16 = array('first' => array('value' => '您的' . $_var_14[$_var_15['rtype']] . '申请被商家驳回，可与商家协商沟通！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => 'yen' . $_var_15['price'] . '元', 'color' => '#4a5077'), 'orderProductName' => array('title' => '商品详情', 'value' => $_var_6 . $_var_8, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $_var_2['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $_var_21, 'color' => '#4a5077'));
...
我们正加速送到您的手上，请您耐心等候。', 'color' => '#4a5077'));
			...
			if ($_var_32 && !empty($_var_2['virtual'])) {
				...
				$_var_34 = '\n' . $_var_22 . '\n' . $_var_2['virtual_str'];
				$_var_16 = array('first' => array('value' => '您购物的物品已自动发货!', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单金额', 'value' => 'yen' . $_var_2['price'] . '元', 'color' => '#4a5077'), 'keyword2' => array('title' => '商品详情', 'value' => $_var_6, 'color' => '#4a5077'), 'keyword3' => array('title' => '收货信息', 'value' => $_var_34, 'color' => '#4a5077'), 'remark' => array('title' => '', 'value' => '\r\n【' . $_var_12['name'] . '】感谢您的支持与厚爱，欢迎您的再次购物！', 'color' => '#4a5077'));
...
谢谢您对我们的支持！', 'color' => '#4a5077'));
				...
				$_var_16 = array('first' => array('value' => '充值退款成功!', 'color' => '#4a5077'), 'reason' => array('title' => '退款原因', 'value' => '【' . $_var_12['name'] . '】充值退款', 'color' => '#4a5077'), 'refund' => array('title' => '退款金额', 'value' => 'yen' . $_var_40['money'] . '元', 'color' => '#4a5077'), 'remark' => array('value' => '
退款成功，请注意查收! 谢谢您对我们的支持！', 'color' => '#4a5077'));
			...
			$_var_16 = array('first' => array('value' => '提现申请已经成功提交!', 'color' => '#4a5077'), 'money' => array('title' => '提现金额', 'value' => 'yen' . $_var_40['money'] . '元', 'color' => '#4a5077'), 'timet' => array('title' => '提现时间', 'value' => date('Y-m-d H:i:s', $_var_40['createtime']), 'color' => '#4a5077'), 'remark' => array('value' => '
请等待我们的审核并打款！', 'color' => '#4a5077'));
			...
			$_var_16 = array('first' => array('value' => '恭喜您成功提现!', 'color' => '#4a5077'), 'money' => array('title' => '提现金额', 'value' => 'yen' . $_var_40['money'] . '元', 'color' => '#4a5077'), 'timet' => array('title' => '提现时间', 'value' => date('Y-m-d H:i:s', $_var_40['createtime']), 'color' => '#4a5077'), 'remark' => array('value' => '
感谢您的支持！', 'color' => '#4a5077'));
			$_var_3 = $_W['siteroot'] . 'app/index.php?i=' . $_W['uniacid'] . '&c=entry&m=ewei_shop&do=member&p=log&type=1';
			...
			$_var_16 = array('first' => array('value' => '抱歉，提现申请审核失败!', 'color' => '#4a5077'), 'money' => array('title' => '提现金额', 'value' => 'yen' . $_var_40['money'] . '元', 'color' => '#4a5077'), 'timet' => array('title' => '提现时间', 'value' => date('Y-m-d H:i:s', $_var_40['createtime']), 'color' => '#4a5077'), 'remark' => array('value' => '
