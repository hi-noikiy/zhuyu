...
if ($operation == 'change') {
	...
	if (!empty($id)) {
		...
		if (count($options) > 0) {
			...
			if ($canedit) {
				$html .= '<th class="info" style="width:130px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">库存</div><div class="input-group"><input type="text" class="form-control option_stock_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_stock\');"></a></span></div></div></th>';
				$html .= '<th class="success" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">销售价格</div><div class="input-group"><input type="text" class="form-control option_marketprice_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_marketprice\');"></a></span></div></div></th>';
				$html .= '<th class="warning" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">市场价格</div><div class="input-group"><input type="text" class="form-control option_productprice_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_productprice\');"></a></span></div></div></th>';
				$html .= '<th class="danger" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">成本价格</div><div class="input-group"><input type="text" class="form-control option_costprice_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_costprice\');"></a></span></div></div></th>';
				$html .= '<th class="primary" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">商品编码</div><div class="input-group"><input type="text" class="form-control option_goodssn_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_goodssn\');"></a></span></div></div></th>';
				$html .= '<th class="danger" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">商品条码</div><div class="input-group"><input type="text" class="form-control option_productsn_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_productsn\');"></a></span></div></div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">重量（克）</div><div class="input-group"><input type="text" class="form-control option_weight_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_weight\');"></a></span></div></div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">直径大小(cm)</div><div class="input-group"><input type="text" class="form-control option_diameter_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_diameter\');"></a></span></div></div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">适合人数（人/数字）</div><div class="input-group"><input type="text" class="form-control option_fitnumber_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_fitnumber\');"></a></span></div></div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">餐具数量（数字）</div><div class="input-group"><input type="text" class="form-control option_tableware_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_tableware\');"></a></span></div></div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">预定提前时间（小时）</div><div class="input-group"><input type="text" class="form-control option_scheduletime_all"  VALUE=""/><span class="input-group-addon"><a href="javascript:;" class="fa fa-hand-o-down" title="批量设置" onclick="setCol(\'option_scheduletime\');"></a></span></div></div></th>';				
				$html .= '</tr></thead>';
			} else {
				$html .= '<th class="info" style="width:130px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">库存</div></div></th>';
				$html .= '<th class="success" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">销售价格</div></div></th>';
				$html .= '<th class="warning" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">市场价格</div></div></th>';
				$html .= '<th class="danger" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">成本价格</div></div></th>';
				$html .= '<th class="primary" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">商品编码</div></div></th>';
				$html .= '<th class="danger" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">商品条码</div></div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">重量（克）</div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">直径大小(cm)</div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">适合人数（人/数字）</div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">餐具数量（数字）</div></th>';
				$html .= '<th class="info" style="width:150px;"><div class=""><div style="padding-bottom:10px;text-align:center;font-size:14px;">预定提前时间（小时）</div></th>';
				$html .= '</tr></thead>';
			}
			for ($m = 0; $m < $len; $m++) {
				$k = 0;
			...
			for ($i = 0; $i < $newlen; $i++) {
				...
				$ids = implode('_', $ids);
				$val = array('id' => "", 'title' => "", 'stock' => "", 'costprice' => "", 'productprice' => "", 'marketprice' => "", 'weight' => "",'diameter' => "",'fitnumber' => "",'tableware' => "",'scheduletime' => "", 'virtual' => '');
				foreach ($options as $o) {
					if ($ids === $o['specs']) {
						$val = array('id' => $o['id'], 'title' => $o['title'], 'stock' => $o['stock'], 'costprice' => $o['costprice'], 'productprice' => $o['productprice'], 'marketprice' => $o['marketprice'], 'goodssn' => $o['goodssn'], 'productsn' => $o['productsn'], 'weight' => $o['weight'],'diameter' => $o['diameter'],'fitnumber' => $o['fitnumber'],'tableware' => $o['tableware'],'scheduletime' => $o['scheduletime'], 'virtual' => $o['virtual']);
						break;
					}
				}
				...
				if ($canedit) {
					...
					$hh .= '<td class="info"><input name="option_diameter_' . $ids . '[]" type="text" class="form-control option_diameter option_diameter_' . $ids . '" " value="' . $val['diameter'] . '"/></td>';
					$hh .= '<td class="info"><input name="option_fitnumber_' . $ids . '[]" type="text" class="form-control option_fitnumber option_fitnumber_' . $ids . '" " value="' . $val['fitnumber'] . '"/></td>';
					$hh .= '<td class="info"><input name="option_tableware_' . $ids . '[]" type="text" class="form-control option_tableware option_tableware_' . $ids . '" " value="' . $val['tableware'] . '"/></td>';					
					$hh .= '<td class="info"><input name="option_scheduletime_' . $ids . '[]" type="text" class="form-control option_scheduletime option_scheduletime_' . $ids . '" " value="' . $val['scheduletime'] . '"/></td>';	
					$hh .= '</tr>';
				} else {
					...
					$hh .= '<td class="info">' . $val['diameter'] . '</td>';
					$hh .= '<td class="info">' . $val['tableware'] . '</td>';
					$hh .= '<td class="info">' . $val['scheduletime'] . '</td>';
					$hh .= '</tr>';
				}
			}
			$html .= $hh;
	...
	if (checksubmit('submit')) {
		...
		if(!empty($_POST['fitnumber'])){
			$data[fitnumber]=$_POST['fitnumber'];	
		}		
		if(!empty($_POST['tableware'])){
			$data[tableware]=$_POST['tableware'];	
		}
		if(!empty($_POST['scheduletime'])){
			$data[scheduletime]=$_POST['scheduletime'];	
		}		
		if(!empty($_POST['referencesweetness'])){
			$data[referencesweetness]=$_POST['referencesweetness'];	
		}		
		if(!empty($_POST['ordertime'])){
			$data[ordertime]=$_POST['ordertime'];	
		}			
		if(!empty($_POST['preservationcondition'])){
			$data[preservationcondition]=$_POST['preservationcondition'];	
		}		
		if(!empty($_POST['suboptimalmatching'])){
			$data[suboptimalmatching]=$_POST['suboptimalmatching'];	
		}
		if(!empty($_POST['burdening1'])){
			$data[burdening1]=$_POST['burdening1'];	
		}			
		if(!empty($_POST['burdening2'])){
			$data[burdening2]=$_POST['burdening2'];	
		}	
		if(!empty($_POST['burdening3'])){
			$data[burdening3]=$_POST['burdening3'];	
		}		
		...
		$option_diameter = $_POST['option_diameter'];		
		$option_fitnumber= $_POST['option_fitnumber'];	
		$option_tableware= $_POST['option_tableware'];	
		$option_scheduletime= $_POST['option_scheduletime'];						
		...
		for ($k = 0; $k < $len; $k++) {
			...
			$a = array('uniacid' => $_W['uniacid'], 'title' => $_GPC['option_title_' . $ids][0], 'productprice' => $_GPC['option_productprice_' . $ids][0], 'costprice' => $_GPC['option_costprice_' . $ids][0],'diameter' => $_GPC['option_diameter_' . $ids][0],'fitnumber' => $_GPC['option_fitnumber_' . $ids][0],'tableware' => $_GPC['option_tableware_' . $ids][0],'scheduletime' => $_GPC['option_scheduletime_' . $ids][0], 'marketprice' => $_GPC['option_marketprice_' . $ids][0], 'stock' => $_GPC['option_stock_' . $ids][0], 'weight' => $_GPC['option_weight_' . $ids][0], 'goodssn' => $_GPC['option_goodssn_' . $ids][0], 'productsn' => $_GPC['option_productsn_' . $ids][0], 'goodsid' => $id, 'specs' => $newids, 'virtual' => $data['type'] == 3 ? $_GPC['option_virtual_' . $ids][0] : 0);
			$totalstocks += $a['stock'];
